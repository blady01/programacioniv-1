      ...
      <div class="row">
        <div class="col-md-4">
          <div class="list-group">
            ...
            <a href="empresa.php" class="list-group-item active">Empresas</a>
        ...
        <?php
          ...
          if($result->num_rows > 0) {
            echo '<h3>Total de empresas: ' . $result->num_rows . '</h3>'; 
          }
        ?>
          <table class="table">
            <thead>
                  ...
                  while($row = $result->fetch_assoc()) {
                    ?>
                      <tr>
                        ...
                        <td><a href="borrar_empresa.php?id=<?php echo $row['idEmpresa']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                      </tr>
                    <?php
                  }
                }
