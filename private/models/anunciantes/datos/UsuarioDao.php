...
class UsuarioDao extends Conexion
{
    ...
    {
        $query = "SELECT * FROM anunciantes WHERE usuario = :usuario AND password = :password";
    ...
    {
        $query = "SELECT id,nombre,email,usuario,privilegio,fecha_registro FROM anunciantes WHERE usuario = :usuario AND password = :password";
    ...
    /**
     * Metodo que sirve para registrar anunciantes
     *
     * @param      object         $usuario
     * @return     boolean
     */
    ...
    {
        $query = "INSERT INTO anunciantes (nombre,email,usuario,password,privilegio) VALUES (:nombre,:email,:usuario,:password,:privilegio)";
